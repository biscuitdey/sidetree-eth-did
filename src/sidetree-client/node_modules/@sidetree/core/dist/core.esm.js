import { PublicKeyPurpose, SidetreeError, ErrorCode, Encoder, Multihash, OperationType, protocolParameters, TransactionProcessingStatus, SharedErrorCode, AnchoredDataSerializer, FetchResultCode, JsonCanonicalizer, ResponseStatus, AbstractVersionMetadata, CoreErrorCode } from '@sidetree/common';
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              deltaJsonString = Encoder.decodeAsString(deltaEncodedString);
              _context.next = 5;
            ...
            case 11:
              ...
              nextUpdateCommitment = Encoder.decodeAsBuffer(delta.update_commitment);
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              suffixDataJsonString = Encoder.decodeAsString(suffixDataEncodedString);
              _context4.next = 5;
            ...
            case 9:
              delta_hash = Encoder.decodeAsBuffer(suffixData.delta_hash);
              nextRecoveryCommitment = Encoder.decodeAsBuffer(suffixData.recovery_commitment);
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return JWK.generate('OKP', 'Ed25519');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              ed25519KeyPair = new Ed25519KeyPair(keyPair);
              _context3.next = 9;
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return JWK.generate('EC', 'secp256k1');
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              publicKeyJwk = from(privateKeyBuffer, 'blk').toJwk('public');
              publicKeyJwk.crv = 'secp256k1';
              privateKeyJwk = from(privateKeyBuffer, 'blk').toJwk('private');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return EdDSA.verify(compactJws, jwk);
            ...
            case 6:
              ...
              _context3.next = 9;
              return ES256K.verify(compactJws, jwk);
            ...
            case 15:
              ...
              console.log("Input '" + compactJws + "' failed signature verification: " + SidetreeError.createFromError(ErrorCode.JwsFailedSignatureValidation, _context3.t0));
              return _context3.abrupt("return", false);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 5;
              return ES256K.sign(payload, privateKey, header);
            ...
            case 6:
              _context4.next = 8;
              return EdDSA.sign(payload, privateKey, header);
    ...
    var _parseSignedDataPayload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(deltaEncodedString, expectedDidUniqueSuffix) {
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              signedDataJsonString = Encoder.decodeAsString(deltaEncodedString);
              _context4.next = 3;
    ...
    var _parseSignedDataPayload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(signedDataEncodedString) {
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              signedDataJsonString = Encoder.decodeAsString(signedDataEncodedString);
              _context4.next = 3;
              return JsonAsync.parse(signedDataJsonString);
            ...
            case 7:
              Jwk.validatePublicJwk(signedData.recovery_key);
              delta_hash = Encoder.decodeAsBuffer(signedData.delta_hash);
              Multihash.verifyHashComputedUsingLatestSupportedAlgorithm(delta_hash);
              nextRecoveryCommitmentHash = Encoder.decodeAsBuffer(signedData.recovery_commitment);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              throw SidetreeError.createFromError(ErrorCode.AnchorFileDecompressionFailure, _context.t0);
            ...
            case 15:
              ...
              throw SidetreeError.createFromError(ErrorCode.AnchorFileNotJson, _context.t1);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              _context.prev = 6;
              _context.t0 = _context["catch"](0);
              throw SidetreeError.createFromError(ErrorCode.MapFileDecompressionFailure, _context.t0);
            ...
            case 15:
              _context.prev = 15;
              _context.t1 = _context["catch"](9);
              throw SidetreeError.createFromError(ErrorCode.MapFileNotJson, _context.t1);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 20:
              ...
              if (!(_context5.t0 instanceof SidetreeError && _context5.t0.code === SharedErrorCode.InvalidTransactionNumberOrTimeHash)) {
                _context5.next = 27;
                break;
              }
      ...
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 1:
              if (!(i < this.transactionsUnderProcessing.length && this.transactionsUnderProcessing[i].processingStatus === TransactionProcessingStatus.Processed)) {
                _context8.next = 7;
                break;
              }
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 16:
              if (!(operationType === OperationType.Deactivate)) {
                _context.next = 20;
                break;
              }
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 23:
              ...
              nextUpdateRevealValueEncodedString = Multihash.canonicalizeThenHashThenEncode(signingPublicKey.jwk);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              _context5.next = 8;
              return OperationGenerator.createUpdateOperationRequestForAddingAKey(didUniqueSuffix, updatePublicKey, updatePrivateKey, additionalPublicKey, Multihash.canonicalizeThenHashThenEncode(additionalPublicKey));
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              delta_hash = Encoder.encode(Multihash.hash(deltaBuffer));
              suffixData = {
                delta_hash: delta_hash,
                recovery_commitment: Multihash.canonicalizeThenHashThenEncode(recoveryPublicKey)
              };
              suffixDataEncodedString = Encoder.encode(JSON.stringify(suffixData));
              deltaEncodedString = Encoder.encode(deltaBuffer);
              operation = {
                type: OperationType.Create,
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              nextUpdateCommitmentHash = Multihash.canonicalizeThenHashThenEncode(nextUpdateKey.jwk);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              delta_hash = Encoder.encode(Multihash.hash(Buffer.from(deltaJsonString)));
              encodedDeltaString = Encoder.encode(deltaJsonString);
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 3;
              return OperationGenerator.createRecoverOperationRequest(didUniqueSuffix, recoveryPrivateKey, newRecoveryPublicKey, Multihash.canonicalizeThenHashThenEncode(newSigningPublicKey.jwk), document);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 8:
              ...
              console.log("Skipped bad operation for DID " + operation.didUniqueSuffix + " at time " + operation.transactionTime + ". Error: " + SidetreeError.stringify(_context5.t0));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 11:
              ...
              hashOfRevealValue = Multihash.hashThenEncode(revealValueBuffer, hashAlgorithm);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              anchoredData = AnchoredDataSerializer.deserialize(transaction.anchorString); // Verify enough fee paid.
            ...
            case 20:
              ...
              if (!(_context.t0 instanceof SidetreeError)) {
                _context.next = 29;
                break;
              }

              if (!(_context.t0.code === ErrorCode.CasNotReachable || _context.t0.code === ErrorCode.CasFileNotFound)) {
                _context.next = 25;
                break;
              }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.next = 5;
              return this.downloadFileFromCas(anchorFileHash, protocolParameters.maxAnchorFileSizeInBytes);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return this.downloadFileFromCas(anchorFileModel.map_file_uri, protocolParameters.maxMapFileSizeInBytes);
            ...
            case 19:
              ...
              if (!(_context3.t0 instanceof SidetreeError)) {
                _context3.next = 27;
                break;
              }

              if (!(_context3.t0.code === ErrorCode.CasNotReachable || _context3.t0.code === ErrorCode.CasFileNotFound)) {
                _context3.next = 24;
                break;
              }
            ...
            case 27:
              console.error("Unexpected error fetching map file " + anchorFile.model.map_file_uri + ", MUST investigate and fix: " + SidetreeError.stringify(_context3.t0));
              return _context3.abrupt("return", undefined);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              _context4.next = 7;
              return this.downloadFileFromCas(chunkFileHash, protocolParameters.maxChunkFileSizeInBytes);
            ...
            case 14:
              ...
              if (!(_context4.t0 instanceof SidetreeError)) {
                _context4.next = 22;
                break;
              }

              if (!(_context4.t0.code === ErrorCode.CasNotReachable || _context4.t0.code === ErrorCode.CasFileNotFound)) {
                _context4.next = 19;
                break;
              }
            ...
            case 22:
              console.error("Unexpected error fetching chunk file " + chunkFileHash + ", MUST investigate and fix: " + SidetreeError.stringify(_context4.t0));
              return _context4.abrupt("return", undefined);
            ...
            case 2:
              ...
              if (transactions) {
                for (_iterator3 = _createForOfIteratorHelperLoose(transactions); !(_step3 = _iterator3()).done;) {
                  ...
                  try {
                    numOfOperationsInCurrentTransaction = AnchoredDataSerializer.deserialize(transaction.anchorString).numberOfOperations;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 42:
              ...
              stringToWriteToBlockchain = AnchoredDataSerializer.serialize(dataToBeAnchored);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              _context2.next = _context2.t0 === OperationType.Recover ? 8 : _context2.t0 === OperationType.Update ? 11 : 14;
              break;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              isMatchingDelta = Multihash.isValidHash(operation.encodedDelta, operation.suffixData.delta_hash);
            ...
            case 14:
              ...
              console.debug("Unable to apply document patch in transaction number " + transactionNumber + " for DID " + didUniqueSuffix + ": " + SidetreeError.stringify(_context3.t0) + "."); // Return the given DID state if error is encountered applying the patches.
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              isValidUpdateKey = Multihash.canonicalizeAndVerify(operation.signedData.update_key, didState.nextUpdateCommitmentHash);
            ...
            case 11:
              ...
              isValidDelta = Multihash.isValidHash(operation.encodedDelta, operation.signedData.delta_hash);
            ...
            case 20:
              ...
              didUniqueSuffix = anchoredOperationModel.didUniqueSuffix;
              transactionNumber = anchoredOperationModel.transactionNumber;
              console.debug("Unable to apply document patch in transaction number " + transactionNumber + " for DID " + didUniqueSuffix + ": " + SidetreeError.stringify(_context4.t0) + "."); // Return the given DID state if error is encountered applying the patches.
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              isValidRecoveryKey = Multihash.canonicalizeAndVerify(operation.signedData.recovery_key, didState.nextRecoveryCommitmentHash);
            ...
            case 11:
              ...
              isMatchingDelta = Multihash.isValidHash(operation.encodedDelta, operation.signedData.delta_hash);
            ...
            case 20:
              ...
              didUniqueSuffix = anchoredOperationModel.didUniqueSuffix;
              transactionNumber = anchoredOperationModel.transactionNumber;
              console.debug("Unable to apply document patch in transaction number " + transactionNumber + " for DID " + didUniqueSuffix + ": " + SidetreeError.stringify(_context5.t0) + "."); // Return the given DID state if error is encountered applying the patches.
...
var Did = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              suffixDataHashMatchesUniqueSuffix = Multihash.isValidHash(createOperation.encodedSuffixData, did.uniqueSuffix); // If the computed suffix data hash is not the same as the unique suffix given in the DID string, the DID is not valid.
  ...
  Did.getInitialStateFromDidString = function getInitialStateFromDidString(didString, methodNameWithNetworkId) {
    ...
    try {
      didStringUrl = new URL$1(didString);
    } catch (_unused) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              errorMessage = "operationDdata byte size of " + deltaBuffer.length + " exceeded limit of " + protocolParameters.maxDeltaSizeInBytes;
            ...
            case 29:
              ...
              _context.next = _context.t1 === OperationType.Create ? 34 : _context.t1 === OperationType.Update ? 38 : _context.t1 === OperationType.Recover ? 38 : _context.t1 === OperationType.Deactivate ? 38 : 40;
              break;
            ...
            case 47:
              ...
              if (!(_context.t2 instanceof SidetreeError)) {
                _context.next = 52;
                break;
              }
...
var VersionMetadata = /*#__PURE__*/function (_AbstractVersionMetad) {
  ...
  function VersionMetadata() {
    ...
    _this.hashAlgorithmInMultihashCode = protocolParameters.hashAlgorithmInMultihashCode;
    _this.normalizedFeeToPerOperationFeeMultiplier = protocolParameters.normalizedFeeToPerOperationFeeMultiplier;
    _this.valueTimeLockAmountMultiplier = protocolParameters.valueTimeLockAmountMultiplier;
    return _this;
  }
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              return _context2.abrupt("return", MongoDbOperationQueue);
            ...
            case 12:
              _context2.next = 14;
              return import("./versions/" + version + "/" + className);
...
export { AnchorFile, BatchScheduler, ChunkFile, Compressor, CreateOperation, DeactivateOperation, DownloadManager, JsonAsync, Jwk, Jws, MapFile, Observer, Operation, OperationGenerator, RecoverOperation, Resolver, ServiceInfoProvider as ServiceInfo, TransactionProcessor, UpdateOperation, VersionManager };
