        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return MongoClient.connect(this.serverUrl, {
                useUnifiedTopology: true,
                useNewUrlParser: true
              });
...
export { MongoDb, MongoDbCasCache, MongoDbOperationQueue, MongoDbOperationStore, MongoDbTransactionStore, MongoDbUnresolvableTransactionStore };
