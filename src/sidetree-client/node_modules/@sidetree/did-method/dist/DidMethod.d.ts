...
import { Config, ResponseModel, ProtocolVersionModel, IBlockchain, ICas } from '@sidetree/common';
import { VersionManager } from '@sidetree/core';
import { MongoDbOperationStore, MongoDbTransactionStore } from '@sidetree/db';
/**
...
export default class DidMethod {
    ...
    private resolver;
    private serviceInfo;
    constructor(config: Config, protocolVersions: ProtocolVersionModel[], blockchain: IBlockchain, cas: ICas);
    /**
     ...
     */
    initialize(startObserver?: boolean, startBatchWriter?: boolean, startPeriodicCachedBlockchainTimeRefresh?: boolean): Promise<void>;
    /**
