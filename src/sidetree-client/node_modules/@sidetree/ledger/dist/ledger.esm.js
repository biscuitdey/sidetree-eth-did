...
var MockLedger = /*#__PURE__*/function () {
  ...
  _proto.write = /*#__PURE__*/function () {
    var _write = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(anchorString, _fee) {
  ...
  _proto.read = /*#__PURE__*/function () {
    var _read = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(sinceTransactionNumber, _transactionTimeHash) {
      var transactions;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              transactions = this.hashes.map(function (hash, index) {
                return {
  ...
  _proto.getFirstValidTransaction = /*#__PURE__*/function () {
    var _getFirstValidTransaction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(_transactions) {
    ...
    function getFirstValidTransaction(_x5) {
...
var testSuite = function testSuite(ledger) {
  describe(ledger.constructor.name, function () {
    ...
    describe('getServiceVersion', function () {
      it('should get service version', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
        var serviceVersion;
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return ledger.getServiceVersion();

              case 2:
                serviceVersion = _context2.sent;
    ...
    describe('write', function () {
      it('should write to the ledger', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
        return runtime_1.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return ledger.write(anchorString, 0);
    ...
    describe('getApproximateTime', function () {
      it('should get latest cached blockchain time', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4() {
        var realTime, cachedTime;
        return runtime_1.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return ledger.getLatestTime();

              case 2:
                realTime = _context4.sent;
                _context4.next = 5;
                return ledger.approximateTime;

              case 5:
                cachedTime = _context4.sent;
    ...
    describe('read', function () {
      ...
      it('should get all transactions', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5() {
        var readResult, readResult2;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                _context5.next = 13;
                return ledger.write(anchorString2, 0);
      ...
      it('should get a specific transaction', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6() {
        var readResult;
        return runtime_1.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return ledger.read(undefined, transactionTimeHash);

              case 2:
                readResult = _context6.sent;
                expect(readResult.moreTransactions).toBeFalsy();
                expect(readResult.transactions).toHaveLength(1);
      ...
      it('should get all transactions since a block', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7() {
        var readResult;
        return runtime_1.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return ledger.write(anchorString3, 0);

              case 2:
                _context7.next = 4;
                return ledger.read(sinceTransactionNumber);

              case 4:
                readResult = _context7.sent;
                expect(readResult.moreTransactions).toBeFalsy();
                expect(readResult.transactions).toHaveLength(2);
                expect(readResult.transactions[0].transactionNumber).toBeGreaterThanOrEqual(sinceTransactionNumber);
                expect(readResult.transactions[1].transactionNumber).toBeGreaterThanOrEqual(readResult.transactions[0].transactionNumber);
      ...
      it('should return no transaction if the requested transactionNumber has not been reached', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8() {
        var readResult;
        return runtime_1.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return ledger.read(Number.MAX_SAFE_INTEGER - 1);

              case 2:
                readResult = _context8.sent;
                expect(readResult.moreTransactions).toBeFalsy();
      ...
      it('should return no transaction if the requested transactionTimeHash doesnt exist', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee9() {
        var readResult;
        return runtime_1.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return ledger.read(undefined, '0x123');

              case 2:
                readResult = _context9.sent;
                expect(readResult.moreTransactions).toBeFalsy();
                expect(readResult.transactions).toHaveLength(0);
