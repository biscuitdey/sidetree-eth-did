...
var minimalCipher = require('minimal-cipher');
...
var unlockDidKey = function unlockDidKey(seed) {
  try {
    return Promise.resolve(didKeyEd25519.Ed25519KeyPair.generate({
      ...
      return Promise.resolve(didKeyEd25519.driver.resolve(ed25519Key.controller)).then(function (result) {
...
var unlockContent = function unlockContent(_ref3) {
  ...
  try {
    return Promise.resolve(cipher.decryptObject({
      jwe: content,
      keyAgreementKey: new didKeyX25519.X25519KeyPair(keyAgreementKey)
    }));
  } catch (e) {
    return Promise.reject(e);
  }
...
var walletFactory = /*#__PURE__*/Factory.Sync.makeFactory(walletDefaults);

exports.getKeyResolver = getKeyResolver;
exports.lockContent = lockContent;
exports.lockContents = lockContents;
exports.lockDidKey = lockDidKey;
exports.passwordToKey = passwordToKey;
exports.seedToId = seedToId;
exports.unlockContent = unlockContent;
exports.unlockContents = unlockContents;
exports.unlockDidKey = unlockDidKey;
exports.walletDefaults = walletDefaults;
exports.walletFactory = walletFactory;
//# sourceMappingURL=universal-wallet.cjs.development.js.map
